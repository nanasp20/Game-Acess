...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const formCadastro = document.querySelector('form[action="/login"]'); 
    
   
    const formCadastroAntigo = document.querySelector('form[action="login.html"]'); 

    if (formCadastro) {
        formCadastro.addEventListener('submit', validarCadastro);
    } else if (formCadastroAntigo) {
        formCadastroAntigo.addEventListener('submit', validarCadastro);
    }
